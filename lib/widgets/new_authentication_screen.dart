...
class NewAuthFormWidget extends StatefulWidget {
  final Widget child;
  final Widget? footer;
  ...
  @override
  State<NewAuthFormWidget> createState() => _NewAuthFormWidgetState();
}

class _NewAuthFormWidgetState extends State<NewAuthFormWidget> {
